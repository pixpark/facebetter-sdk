...
- (void)viewDidLoad {
  ...
  self.panelHeightConstraint = [self.beautyPanelViewController.view.heightAnchor constraintEqualToConstant:180];
  ...
  [NSLayoutConstraint activateConstraints:@[
    ...
    [self.previewView.bottomAnchor constraintEqualToAnchor:self.beautyPanelViewController.view.topAnchor],
