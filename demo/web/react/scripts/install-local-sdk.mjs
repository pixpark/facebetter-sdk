...
import { assertLocalSdk, demoRoot, localFacebetterCoreRel, localFacebetterRel, useLocalSdk } from '../sdk-source.mjs'
...
pkg.dependencies.facebetter = `file:${localFacebetterRel}`
pkg.dependencies['facebetter-core'] = `file:${localFacebetterCoreRel}`
